...
export default function EditVin() {
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            axios.get(`/api/vins/${id}`),
        ])
            .then(([paysRes, regionsRes, millesimesRes, vinRes]) => {
    ...
    async function handleSubmit(e) {
        ...
        try {
            await axios.post(`/api/vins/${id}`, formData, {
                headers: {
            ...
            setSuccess(true);
            setTimeout(() => navigate(`/vins/${id}`), 2000);
        } catch (err) {
    ...
    return (
        <div className="auth-page">
            <div className="auth-card">
                <h2 className="auth-title">Modifier le vin</h2>

                {success && (
                    <div className="auth-alert success">
                        Vin modifié avec succès ! Redirection...
                    </div>
                )}
                    ...
                    <div className="form-group">
                        ...
                        {currentImage && (
                            <div style={{ marginTop: "8px" }}>
                                <p style={{ color: "#d7cfe1" }}>
                                    Image actuelle:
                                </p>
                                <img
                                    src={`/storage/images/upload/${currentImage}`}
                                    alt="Image actuelle"
                                    style={{
                                        width: "100%",
                                        maxWidth: "280px",
