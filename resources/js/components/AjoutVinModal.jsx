...
export default function AjoutVinModal({ isOpen, onClose, onSuccess }) {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const response = await axios.post("/api/vins", formData, {
                headers: {
                    ...
                    <form onSubmit={handleSubmit} encType="multipart/form-data">
                        ...
                        <div className="form-group">
                            ...
                            <select
                                ...
                                onChange={handleChange}
                                className={
                                    errors.id_millesime ? "is-invalid" : ""
                                }
                                required
                            >
                                <option value="">
                                    Sélectionner un millésime
                                </option>
                                {millesimes.map((m) => (
